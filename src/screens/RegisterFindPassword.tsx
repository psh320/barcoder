...
export const RegisterFindPassword = () => {
  ...
  const onSendMessage = (data: {phone: string}) => {
  ...
  const onSubmit = () => {
    if (String(authInput) !== String(authKey)) {
      setAuthError(true);
    } else {
      navigation.navigate('RegisterChangePassword', {phoneNumber: phoneInput});
    }
  };
      ...
      <View style={[{marginHorizontal: 16, flex: 1}]}>
        ...
        <View style={{justifyContent: 'space-between', flex: 1}}>
          <View style={[{marginHorizontal: 16}]}>
            <RegisterTitleView title="가입하신 연락처를 인증해주세요." />
            ...
            <View style={[{flexDirection: 'row', alignItems: 'center'}]}>
              ...
              <TouchableOpacity
                onPress={() => {
                  onSendMessage({phone: phoneInput});
                }}
                style={{
                ...
                <Text style={{color: '#000000'}}>다시 발송</Text>
              </TouchableOpacity>
            </View>
